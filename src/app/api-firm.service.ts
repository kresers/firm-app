...
export class ApiFirmService {
    static BASE_URL = 'https://public.opendatasoft.com/api/records/1.0/search/?dataset=sirene&start=0';
    static BASE_URL_MAP = 'https://public.opendatasoft.com/explore/embed/dataset/base-sirene@datanova/map?';
